...
client.commands.get('unblacklist').execute(message, args)
    ...
    if(command.toLowerCase() === "stickers" || command.toLowerCase() === "sticker") {
      client.commands.get("stickers").execute(message, args)
    }
...
client.on('guildCreate', guild => {
	...
	const newserverjoinembed = new Discord.MessageEmbed()
		.setTitle('Hello!')
		.setDescription(
			'Hey there! Thank you for inviting Bank Bot to your serve?  If need any help with commands the just type `b!help` and you will know all of the commands you need to know, and you will have fun with the bot!'
		.setColor('PURPLE')
		.setFooter('Hello')
		.setTimestamp()
		)
